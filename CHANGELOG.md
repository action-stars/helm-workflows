...
- Update _the github-actions group with 3 updates in the / directory: [action-stars/generic-workflows](https://github.com/action-stars/generic-workflows), [action-stars/install-tool-_ from `-github-release](https://github.com/action-stars/install-` to `ol-from-github-release) and [docker/login-action](https://github.com/docker/login-action)`. ([#102](https://github.com/action-stars/helm-workflows/pull/102)) _@dependabot_
- Update _action-stars/generic-workflows_ from `0.7.1` to `0.7.2`. ([#102](https://github.com/action-stars/helm-workflows/pull/102)) _@dependabot_
- Update _action-stars/install-tool-_ from `-github-release` from 0.2.5` to `0.2.6`. ([#102](https://github.com/action-stars/helm-workflows/pull/102)) _@dependabot_
- Update _docker/login-action_ from `3.5.0` to `3.6.0`. ([#102](https://github.com/action-stars/helm-workflows/pull/102)) _@dependabot_
